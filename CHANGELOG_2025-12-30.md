...
- **스마트 조사 처리(Smart Josa)**: MapKit 경로 안내 데이터에도 받침 자동 감지 로직을 적용하여, "2호선**을** 탑승"과 같이 조사가 자연스럽게 연결되도록 했습니다.
...
### 3. 기능 및 구조 개선
- **도보 단계 필터링**: 사용자의 요청에 따라 대중교통 경로에서 번거로운 '도보 이동' 상세 단계를 생략하고, 탑승/환승 위주의 핵심 정보만 제공합니다. (기존 방식 복구)
