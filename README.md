...
**DigitalCane**은 시각장애인의 독립적인 이동을 보조하기 위해 개발된 iOS 내비게이션 애플리케이션입니다. 사용자 주변의 편의 시설을 탐색하는 '디지털 지팡이' 모드와, 대중교통 및 도보를 포함한 '대중교통경로안내' 기능을 제공합니다.
...
- **음성 명령**: 화면을 길게 누르고 "서울역으로 가줘", "강남역에서 코엑스 가는 법"과 같이 출발지와 목적지를 포함하여 자유롭게 말하면 AI가 의도를 파악합니다.
- **지능형 경로 탐색**: 
